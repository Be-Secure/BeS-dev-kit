...
def objective(OSSP_name, version):
    #data
    desc1 = 'One key concern in the open source software is often the security vulnerability and operational risk. As part of the code readiness for '+OSSP_name+' (Version: '+version+'), below industry recommended assessments are done on source code of '+OSSP_name+' (Version: '+version+') to understand where does it stand in terms of code level risk.'
    desc2 = 'The outcome of the risk assessment outlines the below listed risk parameters of '+OSSP_name+' (Version: '+version+') source code.'
    bullet_items1= [
