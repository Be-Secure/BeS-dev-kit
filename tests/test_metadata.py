...
def test_id_project_mismatch(ossp_master_fixture):
    with patch('besecure_developer_toolkit.src.CreateOsspMaster.urlopen') as mock_urlopen:
        mock_data = {'url': 'https://api.github.com/repos/Be-Secure/Be-Secure/issues/136', 'repository_url': 'https://api.github.com/repos/Be-Secure/Be-Secure', 'labels_url': 'https://api.github.com/repos/Be-Secure/Be-Secure/issues/136/labels{/name}', 'comments_url': 'https://api.github.com/repos/Be-Secure/Be-Secure/issues/136/comments', 'events_url': 'https://api.github.com/repos/Be-Secure/Be-Secure/issues/136/events', 'html_url': 'https://github.com/Be-Secure/Be-Secure/issues/136', 'id': 1615030821, 'node_id': 'I_kwDOCkfhIc5gQ2ol', 'number': 136, 'title': 'TAVOSS-TR: fastjson', 'user': {'login': 'vasanthtech', 'id': 103616400, 'node_id': 'U_kgDOBi0PkA', 'avatar_url': 'https://avatars.githubusercontent.com/u/103616400?v=4', 'gravatar_id': '', 'url': 'https://api.github.com/users/vasanthtech', 'html_url': 'https://github.com/vasanthtech', 'followers_url': 'https://api.github.com/users/vasanthtech/followers', 'following_url': 'https://api.github.com/users/vasanthtech/following{/other_user}', 'gists_url': 'https://api.github.com/users/vasanthtech/gists{/gist_id}', 'starred_url': 'https://api.github.com/users/vasanthtech/starred{/owner}{/repo}', 'subscriptions_url': 'https://api.github.com/users/vasanthtech/subscriptions', 'organizations_url': 'https://api.github.com/users/vasanthtech/orgs', 'repos_url': 'https://api.github.com/users/vasanthtech/repos', 'events_url': 'https://api.github.com/users/vasanthtech/events{/privacy}', 'received_events_url': 'https://api.github.com/users/vasanthtech/received_events', 'type': 'User', 'site_admin': False}, 'labels': [{'id': 5239729079, 'node_id': 'LA_kwDOCkfhIc8AAAABOE_rtw', 'url': 'https://api.github.com/repos/Be-Secure/Be-Secure/labels/COM%20-%20C', 'name': 'COM - C', 'color': '69c3d7', 'default': False, 'description': None}, {'id': 5239729093, 'node_id': 'LA_kwDOCkfhIc8AAAABOE_rxQ', 'url': 'https://api.github.com/repos/Be-Secure/Be-Secure/labels/IND-ALL', 'name': 'IND-ALL', 'color': '7030a0', 'default': False, 'description': None}, {'id': 5239729136, 'node_id': 'LA_kwDOCkfhIc8AAAABOE_r8A', 'url': 'https://api.github.com/repos/Be-Secure/Be-Secure/labels/L&F', 'name': 'L&F', 'color': 'ffff00', 'default': False, 'description': None}, {'id': 5239729184, 'node_id': 'LA_kwDOCkfhIc8AAAABOE_sIA', 'url': 'https://api.github.com/repos/Be-Secure/Be-Secure/labels/Tracked', 'name': 'Tracked', 'color': '2FC2EB', 'default': False, 'description': None}], 'state': 'open', 'locked': False, 'assignee': None, 'assignees': [{'login': 'asa1997', 'id': 58501088, 'node_id': 'MDQ6VXNlcjU4NTAxMDg4', 'avatar_url': 'https://avatars.githubusercontent.com/u/58501088?v=4', 'gravatar_id': '', 'url': 'https://api.github.com/users/asa1997', 'html_url': 'https://github.com/asa1997', 'followers_url': 'https://api.github.com/users/asa1997/followers', 'following_url': 'https://api.github.com/users/asa1997/following{/other_user}', 'gists_url': 'https://api.github.com/users/asa1997/gists{/gist_id}', 'starred_url': 'https://api.github.com/users/asa1997/starred{/owner}{/repo}', 'subscriptions_url': 'https://api.github.com/users/asa1997/subscriptions', 'organizations_url': 'https://api.github.com/users/asa1997/orgs', 'repos_url': 'https://api.github.com/users/asa1997/repos', 'events_url': 'https://api.github.com/users/asa1997/events{/privacy}', 'received_events_url': 'https://api.github.com/users/asa1997/received_events', 'type': 'User', 'site_admin': False}], 'milestone': None, 'comments': 0, 'created_at': '2022-07-20T07:31:43Z', 'updated_at': '2023-03-29T11:07:57Z', 'closed_at': None, 'author_association': 'NONE', 'active_lock_reason': None, 'body': '### Version of the project\r\n\r\n1.2.24\r\n\r\n### Tech Stack\r\n\r\nLanguage and Framwork [L&F]\r\n\r\n### Project details\r\n\r\nFastjson is a Java library that can be used to convert Java Objects into their JSON representation. It can also be used to convert a JSON string to an equivalent Java object. Fastjson can work with arbitrary Java objects including pre-existing objects that you do not have source-code of.\r\n\r\nFastjson Goals\r\n\r\n    Provide the best performance on the server-side and android client\r\n    Provide simple toJSONString() and parseObject() methods to convert Java objects to JSON and vice-versa\r\n    Allow pre-existing unmodifiable objects to be converted to and from JSON\r\n    Extensive support of Java Generics\r\n    Allow custom representations for objects\r\n    Support arbitrarily complex objects (with deep inheritance hierarchies and extensive use of generic types)\r\n\r\n\r\n### Languages used\r\n\r\nJava \r\n\r\n### Domain\r\n\r\nWeb Development\r\n\r\n### Industry\r\n\r\nAll\r\n\r\n### Open Source Project type\r\n\r\nCommunity led\r\n\r\n### Repo URL\r\n\r\nhttps://github.com/alibaba/fastjson.git\r\n\r\n### Sub-project repo URL\r\n\r\n_No response_\r\n\r\n### Webpage\r\n\r\n_No response_\r\n\r\n### License\r\n\r\nApache-2.0\r\n\r\n### Other license\r\n\r\n_No response_\r\n\r\n### Reason , why we must track this project.\r\n', 'closed_by': None, 'reactions': {'url': 'https://api.github.com/repos/Be-Secure/Be-Secure/issues/136/reactions', 'total_count': 0, '+1': 0, '-1': 0, 'laugh': 0, 'hooray': 0, 'confused': 0, 'heart': 0, 'rocket': 0, 'eyes': 0}, 'timeline_url': 'https://api.github.com/repos/Be-Secure/Be-Secure/issues/136/timeline', 'performed_via_github_app': None, 'state_reason': None}
        mock_response = Mock()
...
def test_write_tech_stack(ossp_master_fixture):
    ...
    with patch('besecure_developer_toolkit.src.CreateOsspMaster.urlopen') as mock_urlopen:
        ...
        mock_response.read.return_value = json.dumps(mock_data).encode()
        mock_urlopen.return_value = mock_response
        result = OSSPMaster.write_tech_stack(ossp_master_fixture.id)
